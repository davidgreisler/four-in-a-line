 ...
 */
QSharedPointer<Replay> Replay::CreateFromString(const QString& string, PlayerFactory& playerFactory)
{
 ...
 */
QSharedPointer<Replay> Replay::CreateFromGame(QSharedPointer<const Game> game, PlayerFactory& playerFactory)
{
	QSharedPointer<Replay> result;
