#ifndef GAME_FOUR_IN_A_LINE_BOARD_HPP
#define GAME_FOUR_IN_A_LINE_BOARD_HPP
 ...
 */
class Board : public ::Game::Board
{
	public:
		/**
		 * Represents an empty cell in the grid.
		 */
		static const ::Game::Board::TokenType CELL_EMPTY;
		...
		void dropToken(unsigned int x, ::Game::Board::TokenType token);
	...
	protected:
		using ::Game::Board::setCell;
		using ::Game::Board::swapCells;
};

}
}

#endif // GAME_FOUR_IN_A_LINE_BOARD_HPP
