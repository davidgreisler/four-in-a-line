 ...
 */
AbstractPlayer::AbstractPlayer(::GameLogic::FourInALine::Game::PlayerType playerId, QString name, QObject* parent)
 ...
 */
::GameLogic::FourInALine::Game::PlayerType AbstractPlayer::getPlayer() const
{
	return this->player;
}
