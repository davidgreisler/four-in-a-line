...
AbstractStyle
{
    ...
    /**
     * Token image for player one.
     */
    property string firstPlayerImage: "images/token.svg"

    /**
     * Token image for player one.
     */
    property string secondPlayerImage: "images/token2.svg"
    ...
    Image
    {
        ...
        y: _widget.y
        z: 2
        width: (_widget.board.cellWidth / 100) * 90;
        height: (_widget.board.cellHeight / 100) * 90;

        opacity: 0.0
        source: (_widget.playerId === 1) ? firstPlayerImage : secondPlayerImage
        smooth: true
        mipmap: true
    }
